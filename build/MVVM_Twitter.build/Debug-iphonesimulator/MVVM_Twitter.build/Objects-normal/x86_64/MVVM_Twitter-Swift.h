...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVVM_Twitter",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12MVVM_Twitter11AppDelegate")
...
SWIFT_CLASS("_TtC12MVVM_Twitter17ExploreController")
...
@interface ExploreController (SWIFT_EXTENSION(MVVM_Twitter)) <UISearchResultsUpdating>
...
@interface ExploreController (SWIFT_EXTENSION(MVVM_Twitter))
...
SWIFT_CLASS("_TtC12MVVM_Twitter14FeedController")
...
@interface FeedController (SWIFT_EXTENSION(MVVM_Twitter)) <UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC12MVVM_Twitter23NotificationsController")
...
SWIFT_CLASS("_TtC12MVVM_Twitter17ProfileController")
...
@interface ProfileController (SWIFT_EXTENSION(MVVM_Twitter)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end

@class UICollectionReusableView;

@interface ProfileController (SWIFT_EXTENSION(MVVM_Twitter))
...
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)handleFollowingLabel;
- (void)handleFollowersabel;
...
SWIFT_CLASS("_TtC12MVVM_Twitter13SceneDelegate")
...
SWIFT_CLASS("_TtC12MVVM_Twitter9TweetCell")
@interface TweetCell : UICollectionViewCell
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)handleProfileImageTapped;
- (void)handleCommentTapped;
- (void)handleRetweetTapped;
- (void)handleLikeTapped;
- (void)handleShareTapped;
@end


SWIFT_CLASS("_TtC12MVVM_Twitter15TweetController")
@interface TweetController : UICollectionViewController
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithCollectionViewLayout:(UICollectionViewLayout * _Nonnull)layout SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil SWIFT_UNAVAILABLE;
@end
...
@interface TweetController (SWIFT_EXTENSION(MVVM_Twitter)) <UICollectionViewDelegateFlowLayout>
- (CGSize)collectionView:(UICollectionView * _Nonnull)collectionView layout:(UICollectionViewLayout * _Nonnull)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface TweetController (SWIFT_EXTENSION(MVVM_Twitter))
- (UICollectionViewCell * _Nonnull)collectionView:(UICollectionView * _Nonnull)collectionView cellForItemAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
- (NSInteger)collectionView:(UICollectionView * _Nonnull)collectionView numberOfItemsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC12MVVM_Twitter11TweetHeader")
@interface TweetHeader : UICollectionReusableView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12MVVM_Twitter8UserCell")
